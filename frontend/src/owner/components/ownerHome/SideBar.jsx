  ...
  return (
    <div className="side-bar ms-4  px-0  py-2 col-md-2 col-sm-4 ">
      <div
        ...
        className="menu-items pt-1 text-center text-white"
      >
        Home
      </div>
      <div
      ...
      {props != "list-vehicle" || props == "add-vehicle" ? (
        <div onClick={() => navigate("/owner/list-vehicle")} className="menu-items pt-1 text-center text-white">
          Vehicles
        </div>
      ) : (
        <div
          onClick={() => navigate("/owner/add-vehicle")}
          className="menu-items-active  pt-1 text-center text-dark fw-bold"
        >
          add vehicle
        </div>
      )}
