...
export default function Coupon() {
  ...
  return (
    <div className=" col-md-10 col-sm-9">
      <button className="btn btn-primary my-3" onClick={() => setVisible(true)}>
        add Coupon
      </button>
      {loading ? (
        <Spinner />
            ...
            <div className="card flex justify-content-center mt-4">
              <form onSubmit={formik.handleSubmit} className="flex flex-column gap-2">
                ...
                <span className="p-float-label py-2 d-block">
                  ...
                  />
                  <label htmlFor="code" className={classNames({ "p-error": isFormFieldInvalid("code") })}>
                    Coupon Code
                  </label>
                </span>
                ...
                <span className="p-float-label py-2 d-block">
                  <Calendar
                    ...
                    dateFormat="dd/mm/yy"
                  />
                  <label htmlFor="expire" className={classNames({ "p-error": isFormFieldInvalid("expire") })}>
                    Expire Date
                  </label>
                </span>
                ...
                <span className="p-float-label py-2 d-block">
                  ...
                  <label htmlFor="disPercent" className={classNames({ "p-error": isFormFieldInvalid("disPercent") })}>
                    Discount Percentage
                  </label>
                </span>
