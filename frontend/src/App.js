    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route exact path="/car-list" element={<UserHome />} />
          ...
          <Route
            ...
            element={
              <OwnerPrivateRoute>
                {" "}
                <VehiclePage props={"list-vehicle"} />
              </OwnerPrivateRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <OwnerPrivateRoute>
                {" "}
                <VehiclePage props={"edit-vehicle"} />{" "}
              </OwnerPrivateRoute>
            }
          />
          <Route
            ...
            element={
              <OwnerPrivateRoute>
                {" "}
                <VehiclePage props={"notifications"} />{" "}
              </OwnerPrivateRoute>
            }
          />
          <Route
          ...
          <Route
            exact
            path="/owner/*"
            element={<UserErrorPage link={"/owner/home"} />}
          />
