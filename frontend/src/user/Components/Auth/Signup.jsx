...
function Signup() {
  ...
  async function userSignup(user) {
    try {
      const { data } = await axios.post(process.env.REACT_APP_URL + "/signup", { user });
        ...
        <div className="formWrapper">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              className={!passwordMatch && "passwordError"}
          ...
          <p>
            You do have an account? <span onClick={() => navigate("/login")}>Login</span>
          </p>
        </div>
      )}
      <ToastContainer />
