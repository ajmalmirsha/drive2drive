...
export default function TermsAndConditions () {
    return (
        <div className="">
            ...
            <p>This Privacy Policy is prepared by GoRIders and whose registered address is GoRiders 123 smStreet calicut, kerala 673019 india (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.</p>
            ...
            <p className="py-3" >We may collect, store and use the following kinds of personal information about individuals who visit and use our website and social media sites:</p>
            <p><span className="fw-bold" >Information you supply to us.</span> You may supply us with information about you by filling in forms on our website or social media. This includes information you provide when you submit a contact/inquiry form. The information you give us may include but is not limited to, your name, address, e-mail address, and phone number.</p>
            ...
            <h3>Contact</h3>
            <p>Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to ajmalmirshaa2004@gmail.com </p>
            </div>
        </div>
    )
}